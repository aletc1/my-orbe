        ...
        {shows.map((show) => (
          <div key={show.name} className="flex items-center gap-3 rounded-md p-2 hover:bg-secondary/40 transition-colors">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[11px] text-muted-foreground">{show.season} — new episodes</div>
            </div>
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="animate-fade-up">
            ...
            <p className="mt-5 max-w-lg text-lg text-muted-foreground leading-relaxed">
              A self-hostable memory layer for the anime and TV you've already watched. Kyomiru surfaces shows that
              quietly got new episodes while you were away.
            </p>
